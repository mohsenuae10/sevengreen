...
- يستخدم HTML للتنسيق (h2, h3, p, ul, ol, strong, em, blockquote)
...
أريد الرد بصيغة JSON التالية:
{
  ...
  "content_ar": "محتوى المقال الكامل بتنسيق HTML (1500-2500 كلمة) يتضمن: مقدمة، فوائد المنتج، طريقة الاستخدام، نصائح، أسئلة شائعة، خاتمة",
