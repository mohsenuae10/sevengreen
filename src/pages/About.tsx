                ...
                <Card>
                  <CardContent className="p-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      لمسة الجمال بدأت من شغف عميق بعالم الجمال والعناية الفاخرة. نحن متجر متخصص في تقديم منتجات الجمال عالية الجودة، من مستحضرات تجميل أصلية إلى منتجات عناية مميزة.
                    </p>
