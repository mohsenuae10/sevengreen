...
export default function About() {
  ...
  return (
    <>
      <SEOHead
        title="من نحن - Seven Green | سفن جرين"
        description="تعرف على Seven Green، متجرك المتخصص في منتجات العناية الطبيعية. نوفر صوابين، شامبوهات، ومنتجات تجميل طبيعية بأعلى جودة."
        keywords="من نحن سفن جرين, عن المتجر, منتجات طبيعية, صوابين طبيعية"
        url="/about"
        type="website"
      />
                ...
                <Card>
                  <CardContent className="p-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      Seven Green بدأت من إيمان عميق بقوة الطبيعة في العناية بالجمال والصحة. نحن متجر متخصص في تقديم منتجات العناية الطبيعية عالية الجودة، من صوابين طبيعية إلى شامبوهات ومنتجات تجميل خالية من المواد الكيميائية الضارة.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      نؤمن بأن الجمال الحقيقي يأتي من الطبيعة، ولذلك نختار كل منتج بعناية فائقة لضمان أفضل تجربة لعملائنا الكرام.
                    </p>
                  </CardContent>
                </Card>
              </div>
