...
export default function FAQ() {
  ...
  const faqs = [
    {
      question: 'ما هي منتجات لمسة الجمال؟',
      answer: 'لمسة الجمال متجر متخصص في منتجات العناية الطبيعية، نقدم صوابين طبيعية، شامبوهات، ومنتجات تجميل خالية من المواد الكيميائية الضارة، مصنوعة من مكونات طبيعية 100%.'
    },
    {
  ...
  const faqSchema = {
    ...
    headline: 'الأسئلة الشائعة - لمسة الجمال',
  ...
  return (
    <>
      <SEOHead
        title="الأسئلة الشائعة - لمسة الجمال للمنتجات الطبيعية"
        description="أسئلة وأجوبة حول منتجات لمسة الجمال الطبيعية: بار الشامبو، سيروم فيتامين سي، طرق الشحن، الإرجاع والاستبدال، طرق الدفع. احصل على إجابات فورية لجميع استفساراتك."
        keywords="أسئلة شائعة لمسة الجمال, استفسارات المنتجات الطبيعية, سياسة الإرجاع, الشحن والتوصيل, طرق الدفع, منتجات طبيعية آمنة, FAQ Lamset Beauty"
