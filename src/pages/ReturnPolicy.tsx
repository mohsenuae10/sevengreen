...
export default function ReturnPolicy() {
  ...
  return (
    <>
      <SEOHead
        title="سياسة الإرجاع والاستبدال - لمسة بيوتي | Lamset Beauty"
        description="سياسة الإرجاع والاستبدال لمنتجات لمسة بيوتي. تعرف على شروط وإجراءات إرجاع المنتجات واسترداد الأموال."
        keywords="سياسة الإرجاع, الاستبدال, استرداد الأموال, لمسة بيوتي"
