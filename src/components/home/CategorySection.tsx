  ...
  return (
    <section className="py-20 bg-background" style={{ minHeight: '700px', contentVisibility: 'auto', containIntrinsicSize: '0 700px', contain: 'layout style' }}>
      <div className="container mx-auto px-4" style={{ animationDelay: delay }}>
        {/* Category Banner */}
        <div className="relative rounded-3xl overflow-hidden mb-8 group" style={{ minHeight: '256px', height: '256px' }}>
        <div className="absolute inset-0">
          <img 
            ...
            loading="lazy"
            style={{ aspectRatio: '1200/256', height: '256px' }}
          />
      ...
      <Carousel
        ...
        className="w-full"
        style={{ minHeight: '400px', height: '400px', contain: 'layout' }}
      >
        <CarouselContent className="-mr-2 md:-mr-4">
          {categoryProducts.map((product) => (
            <CarouselItem key={product.id} className="pr-2 md:pr-4 basis-1/2">
              <ProductCard {...product} />
            </CarouselItem>
          ))}
        </CarouselContent>
