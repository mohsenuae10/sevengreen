...
export const ProductCard = ({ id, name_ar, price, image_url, stock_quantity, category, slug }: ProductCardProps) => {
  ...
  return (
    <Card className="overflow-hidden hover:shadow-luxury transition-all duration-500 group relative bg-gradient-card aspect-square flex flex-col border-2 border-primary/20 hover:border-primary/40 hover:-translate-y-2 animate-fade-in" style={{ contentVisibility: 'auto', contain: 'layout' }}>
      {/* شارة المنتج */}
      {hasBadge && (
